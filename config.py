...
# Each backend can have its own light/standard/powerful models
# Falls back to: backend-specific -> global WORKER_MODEL_* -> WORKER_MODEL -> None
CURSOR_CLI_MODEL_LIGHT = _env_or_default("CURSOR_CLI_MODEL_LIGHT", CURSOR_CLI_MODEL or WORKER_MODEL_LIGHT)
CURSOR_CLI_MODEL_STANDARD = _env_or_default("CURSOR_CLI_MODEL_STANDARD", CURSOR_CLI_MODEL or WORKER_MODEL_STANDARD)
CURSOR_CLI_MODEL_POWERFUL = _env_or_default("CURSOR_CLI_MODEL_POWERFUL", CURSOR_CLI_MODEL or WORKER_MODEL_POWERFUL)

CLAUDE_CODE_CLI_MODEL_LIGHT = _env_or_default("CLAUDE_CODE_CLI_MODEL_LIGHT", CLAUDE_CODE_CLI_MODEL or WORKER_MODEL_LIGHT)
CLAUDE_CODE_CLI_MODEL_STANDARD = _env_or_default("CLAUDE_CODE_CLI_MODEL_STANDARD", CLAUDE_CODE_CLI_MODEL or WORKER_MODEL_STANDARD)
CLAUDE_CODE_CLI_MODEL_POWERFUL = _env_or_default("CLAUDE_CODE_CLI_MODEL_POWERFUL", CLAUDE_CODE_CLI_MODEL or WORKER_MODEL_POWERFUL)

GEMINI_CLI_MODEL_LIGHT = _env_or_default("GEMINI_CLI_MODEL_LIGHT", GEMINI_CLI_MODEL or WORKER_MODEL_LIGHT)
GEMINI_CLI_MODEL_STANDARD = _env_or_default("GEMINI_CLI_MODEL_STANDARD", GEMINI_CLI_MODEL or WORKER_MODEL_STANDARD)
GEMINI_CLI_MODEL_POWERFUL = _env_or_default("GEMINI_CLI_MODEL_POWERFUL", GEMINI_CLI_MODEL or WORKER_MODEL_POWERFUL)
